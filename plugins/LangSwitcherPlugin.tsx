...
import { Locale, LocalizationApi } from "api/localization"

interface BranchSwitcherProps {
  onBranchChange?(branch: string): void
}

export const LocaleSwitcher = ({ onBranchChange }: BranchSwitcherProps) => {
  const cms = useCMS()
  ...
  const [status, setStatus] = React.useState<"pending" | "loaded" | "error">("loaded")
                ...
                <>
                  {filteredOptions.map((option) => (
                    <SelectOption
                      ...
                      active={
                        locale.localeToString(option) === locale.localeToString(locale.locale)
                      }
                      onClick={() => {
...
export const LangSwitcherPlugin = {
